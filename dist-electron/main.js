...
import electron, { app as app$1, nativeImage, Tray, ipcMain as ipcMain$1, BrowserWindow } from "electron";
...
async function listCalendarsEventKit() {
  await ensureBuilt();
...
async function eventsByDayEventKit(args) {
  await ensureBuilt();
...
const codegen_1$13 = requireCodegen();
...
const codegen_1$12 = requireCodegen();
const names$2 = {
...
const codegen_1$11 = requireCodegen();
...
const codegen_1$10 = requireCodegen();
...
ipcMain$1.handle("calendars:list", async () => {
  return await ensureCalendarPrefs();
});
ipcMain$1.handle("calendars:save", async (_evt, prefs) => {
